	...
	function resume_() {
		...
		navigator.mediaDevices.getUserMedia(
			...
			function(audioStream) {
				...
				gousei();
                audioStream = mixX;
				//console.log('audioStream-Track:', audioStream.getTracks()); 
				//window.audioStream = audioStream; // make variable available to browser console
				//Video2.srcObject = audioStream;				
